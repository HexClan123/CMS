	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
			...
			
			{
				...
				{
					try{
					    PreparedStatement ps1=con.prepareStatement("select * from complaintstatus join complaints on complaints.status_of_complaint=complaintstatus.value where complaintID=? and email = ?");
