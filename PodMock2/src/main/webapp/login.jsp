...
<body style="background-color: white; overflow: hidden;">
	...
	<header>
		...
		<div
			...
			<div class="dropdown" style="width: 10.83vw;">
				<button class="dropbtn active" style="width: 12.83vw;">LOGIN</button>
	...
	<form id="loginForm" method="post" action="LoginController" >
		<table align="center">
			...
			<tr></tr>
			<tr>
			<td><label for="username">Captcha:<span
						class="required">*</span></label></td>
				<td colspan="3"><div id="recaptcha-container"></div></td>
			</tr>
			<tr></tr>
			<tr></tr>
			<tr>
			...
			<tr></tr>
			<tr>
				<td align="center" colspan="2"><input type="button" id="verify" value="Login"
					id="verify" onclick="codeverify();">
					</td>
			</tr>
			<tr></tr>
			<tr></tr>
...
<script src="https://www.gstatic.com/firebasejs/6.0.2/firebase.js"></script>
	...
	<script>
		...
		var firebaseConfig = {
    apiKey: "AIzaSyBhOZCClswCLV5OVY8kuisbaY1J0IGUqQw",
    authDomain: "otp-auth-4b9c1.firebaseapp.com",
    projectId: "otp-auth-4b9c1",
    storageBucket: "otp-auth-4b9c1.appspot.com",
    messagingSenderId: "1019568789014",
    appId: "1:1019568789014:web:8da6140c20318b0be90737",
    measurementId: "G-XCECGXMMRT"
  };
		// Initialize Firebase
