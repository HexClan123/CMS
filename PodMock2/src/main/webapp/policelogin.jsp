...
<body style="overflow: hidden; background-color: white;">
	...
	<br>
	<form method="post" action="PoliceLoginController">
		<table align="center">
		<tr><td style="color:red; font-size:18px;" colspan="3"><center><div>${Login}</div></center> </td></tr>
			<tr>
				<td><label for="loginID" style="font-size: medium;">Station Id:<span class="required">*</span>
				</label></td>
				<td><input type="text" name="loginID" placeholder="Enter Station Id"
					required></td>
			</tr>
			<tr>
